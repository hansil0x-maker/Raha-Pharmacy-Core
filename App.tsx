...
const App: React.FC = () => {
    ...
    const handleSale = async () => {
        ...
        try {
            ...
            // التأكد من أن supabase معرف بشكل صحيح
            if (!supabase) {
                console.error('خطأ: متغير supabase غير معرف!');
                throw new Error('supabase client غير متوفر');
            }

            // طباعة البيانات قبل الإرسال للتأكد من المحتوى
            console.log('=== بدء مزامنة Supabase ===');
            console.log('data:', saleData);
            console.log('اسم الجدول: sales');
            console.log('متغير supabase موجود:', !!supabase);
